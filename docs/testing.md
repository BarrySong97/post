...
- Asset and gallery UI: verify board selection, gallery creation, gallery route navigation, thumbnail switching, missing placeholders, and metadata save behavior in the Electron app.
...
- Expand focused tests around asset filtering, saved views, galleries, and repository queries.
