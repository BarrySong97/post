...
export function useInvalidateVaultState() {
  ...
  return useCallback(async () => {
    await Promise.all([
      ...
      queryClient.invalidateQueries(trpc.assets.layoutIndex.queryFilter()),
      queryClient.invalidateQueries(trpc.assets.hydrate.queryFilter()),
      ...
      queryClient.invalidateQueries(trpc.assets.graphData.queryFilter()),
